...
class LoginSerializer(serializers.ModelSerializer):
    ...
    phone_number = PhoneNumberField(required=True) # проверяем корректность введенного номера телефона
...
class VerifyAuthCodeSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        try:
            ...
            raise serializers.ValidationError('Пользователь не сущеcтвует')
